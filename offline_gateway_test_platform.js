...
var j = schedule.scheduleJob('*/15 * * * *', function(){
	...
	db.getConnection(function(err,connection){
		connection.query("update gateway_platform_test.gateway_ping set status = 'Deactive' where date_add(message_datetime, INTERVAL 5 MINUTE) < NOW();",function(err,data){	
...
//console.log(data);		
		if(err) {					
			  console.log('update Gateway status error: ' + err);       
	   	}       
         });
     }); 
