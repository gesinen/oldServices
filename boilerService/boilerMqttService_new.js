...
function decodeBoilerPingTemperatureDistanceV1(decodeDataHexRaw) {
	...
	let byteTemperatura = 0;
	if(decodeDataHex.length > 8 ){
     byteTemperatura = decodeDataHex[9] + decodeDataHex[8];
	}
...
async function main() {
    ...
    let boilerServiceInfo = await getBoilerServiceInfo()
		...
		boilerServiceInfo.push( {
    topic: 'b827eb495f0c/application/1/device/0079e129d522e700/rx',
    sensorId: 6869,
    sensorDevEui: '0079e129d522e700'
  },
  {
    topic: 'dca632143f21/application/1/device/0079e129d522e700/rx',
    sensorId: 6869,
    sensorDevEui: '0079e129d522e700'
  },
  {
    topic: 'e45f01b36d68/application/2/device/0079e129d522e706/rx',
    sensorId: 12239,
    sensorDevEui: '0079e129d522e706'
  },
  {
    topic: 'b827eb18ad13/application/1/device/0079e129d522e632/rx',
    sensorId: 6864,
    sensorDevEui: '0079e129d522e632'
  },
  {
    topic: 'b827eb524297/application/1/device/0079e129d522e631/rx',
    sensorId: 6863,
    sensorDevEui: '0079e129d522e631'
  }
);
...
async function updateBoilerOnDatabaseScheduleV1(boilerId, pingData) {
    ...
    console.log("pingData", pingData, 'https://stage.swat-id.gesinen.com/v2/boiler/devices/pingScheduleV1')
    var options = {
        'method': 'PUT',
        'url': 'https://stage.swat-id.gesinen.com/v2/boiler/devices/pingScheduleV1',  //'http://localhost:8080/v2/boiler/devices/pingScheduleV1',
        'headers': {
...
async function updateBoilerOnDatabaseStatusV1(boilerDevEui, pingData) {
    ...
    console.log("pingData", pingData,'https://stage.swat-id.gesinen.com/v2/boiler/devices/status')
    var options = {
        'method': 'PUT',
        'url': 'https://stage.swat-id.gesinen.com/v2/boiler/devices/status', //'http://localhost:8080/v2/boiler/devices/status',
        'headers': {
            'Content-Type': 'application/json'
        },
        body: JSON.stringify(pingData)
...
async function updateBoilerOnDatabaseDistTempV1(boilerDevEui, pingData) {
    pingData.boilerDevEui = boilerDevEui
    console.log("pingData", pingData,'https://stage.swat-id.gesinen.com/v2/boiler/devices/pingDistTempV1')
    var options = {
        'method': 'PUT',
        'url': 'https://stage.swat-id.gesinen.com/v2/boiler/devices/pingDistTempV1', //'http://localhost:8080/v2/boiler/devices/pingDistTempV1',
        'headers': {
            'Content-Type': 'application/json'
        },
        body: JSON.stringify(pingData)
...
async function getSensorIdByDevEui(devEui) {
    pingData.id = boilerId
    console.log("pingData", pingData,'https://stage.swat-id.gesinen.com/v2/sensor/deveui/' + devEui)
    var options = {
        'method': 'GET',
        'url': 'https://stage.swat-id.gesinen.com/v2/sensor/deveui/' + devEui, //'http://localhost:8080/v2/sensor/deveui/' + devEui,
        'headers': {
            'Content-Type': 'application/json'
        }
...
async function updateBoilerOnDatabaseV2(boilerDevEui, pingData) {
    pingData.boilerDevEui = boilerDevEui
    console.log("pingData", pingData,'https://stage.swat-id.gesinen.com/v2/boiler/devices/ping')
    var options = {
        'method': 'PUT',
        'url': 'https://stage.swat-id.gesinen.com/v2/boiler/devices/ping', //'http://localhost:8080/v2/boiler/devices/ping',
        'headers': {
            'Content-Type': 'application/json'
        },
        body: JSON.stringify(pingData)
...
async function getBoilerServiceInfo() {
    return new Promise(function(resolve, reject) {
        var options = {
            'method': 'GET',
            'url': 'https://stage.swat-id.gesinen.com/v2/boiler/devices/service/info', //'http://localhost:8080/v2/boiler/devices/service/info',
            'headers': {
                'Content-Type': 'application/json'
            }
